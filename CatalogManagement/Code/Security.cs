...
namespace CatalogManagement.Code
{
    public static class Security
    {
        ...
        public static string Encrypt(string text, string pw)
        {
            ...
            using (var password = new Rfc2898DeriveBytes(pw, saltStringBytes, DerivationIterations))
            {
        ...
        {
            return Encrypt(text, BitConverter.ToString(new byte[] { 90, 10, 23, 16, 09, 03 }));
        }

        public static string Decrypt(string text)
        {
            return Decrypt(text, BitConverter.ToString(new byte[] { 90, 10, 23, 16, 09, 03 }));
        }
    }
}