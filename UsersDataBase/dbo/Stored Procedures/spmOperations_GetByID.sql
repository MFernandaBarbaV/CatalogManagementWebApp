...
-- Author:		Esteban Cruz
-- Create date: 
-- Description:	Selecciona el registro de la tabla mOperations donde el identificador primario coincida con el parámetro @OperationID.
-- =============================================
CREATE PROCEDURE [dbo].[spmOperations_GetByID]
(
	@OperationID int
)
AS
