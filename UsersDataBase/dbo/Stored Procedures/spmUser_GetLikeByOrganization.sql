...
-- Author:		Esteban Cruz
-- Create date: 
-- Description:	Selecciona de la tabla mUsers los registros donde la columna Organization coincida con el parámetro @UserOrganization.
-- =============================================
CREATE PROCEDURE [dbo].[spmUser_GetLikeByOrganization]
(
	@UserOrganization varchar(50)
)
AS
BEGIN
	...
	WHERE u.Organization like '%' + @UserOrganization + '%'
