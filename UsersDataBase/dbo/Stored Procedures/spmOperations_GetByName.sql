...
-- Author:		Esteban Cruz
-- Create date: 
-- Description:	Selecciona los registros de la tabla mOperations donde la columna Name coincida con el parámetro @Name.
-- =============================================
CREATE PROCEDURE [dbo].[spmOperations_GetByName]
(
	@Name varchar(50)
)
AS
