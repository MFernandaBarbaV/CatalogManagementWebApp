...
-- Author:		Esteban Cruz
-- Create date: 
-- Description:	Selecciona de la tabla mUsers los registros donde la columna Login coincida con el parámetro @UserLogin.
-- =============================================
CREATE PROCEDURE [dbo].[spmUser_GetLikeByLogin]
(
